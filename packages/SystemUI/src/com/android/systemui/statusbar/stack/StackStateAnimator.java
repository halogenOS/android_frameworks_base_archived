...
public class StackStateAnimator {
    ...
    public static final int ANIMATION_DURATION_WAKEUP = 480;
    public static final int ANIMATION_DURATION_GO_TO_FULL_SHADE = 440;
    public static final int ANIMATION_DURATION_APPEAR_DISAPPEAR = 460;
    ...
    public static final int ANIMATION_DURATION_HEADS_UP_APPEAR = 540;
    ...
    public static final int ANIMATION_DURATION_HEADS_UP_DISAPPEAR = 260;
    public static final int ANIMATION_DURATION_PULSE_APPEAR =
            KeyguardSliceView.DEFAULT_ANIM_DURATION;
    public static final int ANIMATION_DURATION_BLOCKING_HELPER_FADE = 240;
    public static final int ANIMATION_DELAY_PER_ELEMENT_INTERRUPTING = 72;
    public static final int ANIMATION_DELAY_PER_ELEMENT_MANUAL = 32;
    public static final int ANIMATION_DELAY_PER_ELEMENT_GO_TO_FULL_SHADE = 48;
    public static final int DELAY_EFFECT_MAX_INDEX_DIFFERENCE = 2;
    public static final int ANIMATION_DELAY_HEADS_UP = 110;
    public static final int ANIMATION_DELAY_HEADS_UP_CLICKED= 110;
