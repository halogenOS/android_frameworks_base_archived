...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
        ...
        if (Settings.System.getIntForUser(resolver,
                Settings.System.NAVIGATION_BAR_ENABLED, -10,
                    UserHandle.USER_CURRENT) == -10) {
          Settings.System.putIntForUser(resolver,
                 Settings.System.NAVIGATION_BAR_ENABLED, defaultToNavigationBar ? 1 : 0,
                        UserHandle.USER_CURRENT);
          Settings.System.putIntForUser(resolver,
                 Settings.System.HARDWARE_BUTTONS_ENABLED, defaultToNavigationBar ? 0 : 1,
                        UserHandle.USER_CURRENT);
        }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
             ...
             // Disable music and volume control when used as wake key
                if ((result & ACTION_PASS_TO_USER) == 0 && isMusicActive()) {
