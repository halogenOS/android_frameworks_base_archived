...
public abstract class WindowOrientationListener {
    ...
    final class AccelSensorJudge extends OrientationJudge {
        ...
        private static final long PROPOSAL_SETTLE_TIME_NANOS = 35 * NANOS_PER_MS;
        ...
        // can change.
        private static final long PROPOSAL_MIN_TIME_SINCE_FLAT_ENDED_NANOS = 360 * NANOS_PER_MS;

        // The minimum amount of time that must have elapsed since the device stopped
        // swinging (time since device appeared to be in the process of being put down
        // or put away into a pocket) before the proposed rotation can change.
        private static final long PROPOSAL_MIN_TIME_SINCE_SWING_ENDED_NANOS = 210 * NANOS_PER_MS;
        ...
        private static final long SWING_TIME_NANOS = 310 * NANOS_PER_MS;
